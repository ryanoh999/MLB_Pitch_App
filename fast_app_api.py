...
# Mount the static files (React build directory)
app.mount("/static", StaticFiles(directory="build", html=True), name="static")

# Global variables and locks for thread safety
...
def process_new_rows():
    ...
    csv_file = 'gameday_775311.csv'  # Replace with your actual CSV file path
...
# Route to get the latest prediction
...
# If running directly, use Uvicorn to serve the app
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("fast_app_api:app", host="0.0.0.0", port=8000)
